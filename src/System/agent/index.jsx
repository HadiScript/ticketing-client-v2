...
import AgentOpenTicketItems from "./components/AgentOpenTicketItems";
...
const Agent = () => {
  ...
  return (
    <AgentLayout>
      ...
      <small className="text-secondary">Red background means, 1st SLA has breached</small>
      {/* table-responsive */}
